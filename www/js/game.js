function Game (id, team_id, opponent, sport, date, at_home) {
	...
	function listInsert() {
		...
		this.list.append('<li class="forward playerAvatar"><img src="./img/avatar-team-'+ this.sport + '.png"><a href="#' + this.sport + 'game">' + this.getOpponentListing() + "  <span class='li_gamedate'>" + this.date + '</span><input type="hidden" value="' + this.id + '" /></a></li');
	}
